...
type: wiki
status: active
tags: [growdirect, warchest, market, square, smb]
sources:
  - docs/_archive/ip-vault/warchest/sources/35-the-market.md
...
- `docs/_archive/ip-vault/warchest/sources/35-the-market.md` — the war-chest source this card summarizes
