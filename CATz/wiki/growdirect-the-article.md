...
type: wiki
status: active
tags: [growdirect, warchest, article, narrative, long-form]
sources:
  - docs/_archive/ip-vault/warchest/sources/51-the-article.md
...
- `docs/_archive/ip-vault/warchest/sources/51-the-article.md` — the war-chest source this card summarizes
