...
date: 2026-04-22
type: wiki
tags: [growdirect, production-chain, rebuild-pipeline]
sources:
  - docs/_archive/ip-vault/strategy/PRODUCTION_CHAIN_v0.1.md
...
- `docs/_archive/ip-vault/strategy/PRODUCTION_CHAIN_v0.1.md` — the source doc this card summarizes
