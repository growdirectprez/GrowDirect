...
date: 2026-04-22
type: wiki
tags: [growdirect, chirp, udq, branching]
sources:
  - docs/_archive/ip-vault/strategy/Chirp_UDQ_Branch_Strategy_v1.0.md
...
- `docs/_archive/ip-vault/strategy/Chirp_UDQ_Branch_Strategy_v1.0.md` — the source doc this card summarizes
