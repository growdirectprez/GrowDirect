...
Three headline initiative clusters in the property services strategy:

### 1. Planning & Innovation

- Structured works programme from which procurement efficiencies can be exploited
- Best practice + innovation applied to all property services
- Value management balancing cost, risk, value — rolled out across operating businesses
- Integrate property into the investment appraisal process

### 2. Managing the Portfolio

- Maximise sales-space utilisation through innovation
- Generate more sales space from existing non-sales space and through acquisition
- Exploit assets for alternative-use value

### 3. Procurement & Contract Management

- Economies of scale by exploiting synergies in service requirements across operating Divisions
- Comprehensive procurement strategy addressing future needs
- Best practice + innovation in contract management
...
"Consult" and "inform" only populated for minor projects and facilities management where it was felt important to indicate how end users get brought in. Accountability sometimes allocated differently based on size or sensitivity (levels of delegation — not yet defined in this draft).
...
- **Strategy, policy and planning** for P&BS + FM
- **Property Management:** landlord & tenant, rating, acquisitions, disposals, asset management
- **Building Services:** management + delivery of major capital projects, new build + refurbishment, building design + specification, interior design
- **Facilities Management:** maintenance, cleaning, utilities, purchasing

**Level 1 (how we do it):** Create an operating strategy → define business requirements for property → [cascading sub-processes documented with RACI in the DS-processes deck].
