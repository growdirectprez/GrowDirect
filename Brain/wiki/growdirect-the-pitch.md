...
date: 2026-04-22
type: wiki
tags: [growdirect, warchest, pitch, capture-seal-inscribe]
sources:
  - docs/_archive/ip-vault/warchest/sources/02-the-pitch.md
...
- `docs/_archive/ip-vault/warchest/sources/02-the-pitch.md` — the war-chest source this card summarizes
