...
date: 2026-04-22
type: wiki
tags: [growdirect, warchest, process, factory, methodology]
sources:
  - docs/_archive/ip-vault/warchest/sources/49-how-we-build.md
...
- `docs/_archive/ip-vault/warchest/sources/49-how-we-build.md` — the war-chest source this card summarizes
