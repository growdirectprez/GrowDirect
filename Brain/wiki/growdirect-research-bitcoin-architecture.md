...
date: 2026-04-22
type: wiki
tags: [growdirect, research, bitcoin, architecture, protocol]
sources:
  - docs/_archive/ip-vault/Canary_Bitcoin_Architecture_Research_Paper_v1.0.md
...
- `docs/_archive/ip-vault/Canary_Bitcoin_Architecture_Research_Paper_v1.0.md` — the source doc this card summarizes
