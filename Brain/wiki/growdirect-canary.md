...
date: 2026-04-22
type: wiki
tags: [growdirect, warchest, canary, eljeffe, system-architecture]
sources:
  - docs/_archive/ip-vault/warchest/sources/03-canary.md
...
- `docs/_archive/ip-vault/warchest/sources/03-canary.md` — the war-chest source this card summarizes
