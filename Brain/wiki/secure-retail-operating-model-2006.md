...
date: 2026-04-23
type: wiki
tags: [secure, retail-career, ibm-consulting, operating-model, global-grocery-retailer, 2006, pre-secure]
sources:
...
# Retail Operating Model — 2006 (IBM engagement, UK global grocer)

## Summary

Eight draft Top-Down Design decks from the **International Operations Development Design Group** of a **UK global grocery retailer** expanding internationally, June–July 2006. IBM-era consulting engagement (Jeffe's career line) to produce Phase 1 of a **Target Operating Model (TOM)**: a structured set of "what we do / why we do it / how we measure it" across the major business domains of a global retailer, shaping the processes that would then be rolled into IT system design. Source decks labelled "Draft / Sample".

**Deployment archetype:** UK global grocery retailer, multi-country expansion (UK → Central Europe, China, USA), each country reinventing processes locally — hence the need for a canonical operating model that could be replicated and used as the stable spec against which IT systems were scoped.
...
**Context:** the client was expanding internationally and each country was reinventing processes locally. The TOM engagement set out to define one canonical operating model per business domain so best practice could be replicated and IT systems could be specified against a stable spec.
...
Dependencies: Commercial (accurate info for supplier payment + goods valuation); all Head-Office functions (PO raise + invoice authorization); Governance Committee (capital approval); Store Operations (sales + tender accuracy).

Open decisions:
- Group best practice for Invoice Matching (include self-billing?)
- Where should Finance transaction processing sit?
- How will governance over the USA Operating Model be ensured?

### 3. Retail Operations (June 2006)
...
### 4. Space, Range & Display (23 June 2006, v04)
...
### 5. Forecast & Ordering (June 2006, v3)
...
**Role:** Deliver the four people promises — *"treated with respect" · "a manager who helps me" · "an interesting job" · "an opportunity to get on."*

Benefits: the workplace is a great place to work; people are equipped to deliver the shopping-trip promise; right information for strategic decisions + legal compliance.
...
### 7. Property Services (6 July 2006, V.5)
...
The business-model Supply Chain deck. Markitdown extracted slide-number markers only — the deck is image-only (diagrams rendered as raster images without a text layer). Use LibreOffice/PowerPoint/Keynote to view, or OCR the exported images, if the content is needed.
...
- [[Brain/wiki/secure-property-services-operating-model-2002|Property Services Operating Model (2002)]] — earlier adjacent property-services engagement
- [[Brain/wiki/secure-integrated-maps-2003|Integrated Maps (2003)]] — adjacent IBM/SAP integration landscape
- [[Brain/wiki/secure-dv-private-label-2006|Private Label Food Setup Design Validation (Aug 2006)]] — same-year design-validation follow-on
