...
sources:
  - docs/_archive/ip-vault/strategy/Canary_Factory_Process_v1.0.md
...
- `docs/_archive/ip-vault/strategy/Canary_Factory_Process_v1.0.md` — the source doc this card summarizes
