...
date: 2026-04-22
type: wiki
tags: [growdirect, competitive-intel, oracle, oci]
sources:
  - docs/_archive/ip-vault/strategy/CompetitiveIntel_Oracle_OCI_Polling.md
...
- `docs/_archive/ip-vault/strategy/CompetitiveIntel_Oracle_OCI_Polling.md` — the source doc this card summarizes
