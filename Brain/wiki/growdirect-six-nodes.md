...
date: 2026-04-22
type: wiki
tags: [growdirect, warchest, six-node-protocol, architecture]
sources:
  - docs/_archive/ip-vault/warchest/sources/20-six-nodes.md
...
- `docs/_archive/ip-vault/warchest/sources/20-six-nodes.md` — the war-chest source this card summarizes
