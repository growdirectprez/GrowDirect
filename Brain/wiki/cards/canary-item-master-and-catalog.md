...
The Counterpoint-side data-model audit lives at [[counterpoint-catalog-data-model-audit]] (GRO-880). It compares Canary's `catalog.*` schema field-by-field against Counterpoint's REST IM_ITEM / IM_INV / IM_CATEG / SN_SER / VendorItem shapes, and produces a prioritized migration list (P0 / P1 / P2). **Important framing correction from that audit:** Counterpoint's back-office UI has the rich 3D-grid + 3-tier-UOM + 5-level-hierarchy capabilities, but the **REST surface flattens almost all of it**. Canary's schema is closer to Counterpoint REST altitude than the back-office capabilities suggested; the gaps are mostly additive columns, not a fundamental restructure. Read that card before opening any catalog-schema-evolution dispatch.

[[Brain/wiki/cards/store-ops-capability-model]] · [[Brain/wiki/cards/canary-mobile-task-ux-flows]] · [[Brain/wiki/cards/canary-item-setup-screen-decomp]] · [[Brain/wiki/cards/counterpoint-catalog-data-model-audit]] · [[Brain/wiki/cards/square-sample-code-mechanics-inventory]] · [[Brain/wiki/cards/canary-space-range-display-on-floor]] · [[Brain/wiki/cards/canary-purchase-order-lifecycle]] · [[Brain/projects/Canary]]
