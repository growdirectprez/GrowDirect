...
**RaaS tier.** Planogram data storage and listing synchronization is available at all subscription tiers. Automated listing cascade on planogram publication is Operations Agent — Standard tier. Continuous space productivity monitoring and reset candidate surfacing is Operations Agent — Standard tier. AI-assisted space optimization (planogram recommendations based on space productivity data) is Operations Agent — Premium tier.
