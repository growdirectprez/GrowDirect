...
**RaaS tier.** Standard sales audit with batch end-of-day processing is available at all subscription tiers. Real-time intra-day transaction exception monitoring is Operations Agent — Standard tier. Blockchain-anchored audit trail for evidentiary compliance is the Evidence Anchor tier. AI-assisted cashier fraud pattern detection is Operations Agent — Premium tier.
