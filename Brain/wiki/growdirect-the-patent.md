...
date: 2026-04-22
type: wiki
tags: [growdirect, warchest, patent, ip]
sources:
  - docs/_archive/ip-vault/warchest/sources/33-the-patent.md
...
- `docs/_archive/ip-vault/warchest/sources/33-the-patent.md` — the war-chest source this card summarizes
