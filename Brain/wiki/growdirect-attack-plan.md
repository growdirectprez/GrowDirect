...
date: 2026-04-22
type: wiki
tags: [growdirect, attack-plan, execution, sprint]
sources:
  - docs/_archive/ip-vault/strategy/Canary_Attack_Plan_v3.0.md
...
- `docs/_archive/ip-vault/strategy/Canary_Attack_Plan_v3.0.md` — the source doc this card summarizes
