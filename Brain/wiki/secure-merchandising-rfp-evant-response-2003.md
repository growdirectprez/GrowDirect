...
date: 2026-04-23
type: wiki
tags: [secure, retail-career, evant, catalog-retailer, merchandising, rfp, multi-channel, 2003, pre-secure]
sources:
...
# Merchandising System RFP — Evant Response (Sept 2003)

## Summary

Evant's response to a Merchandise Forecasting / Planning **Request for Proposal** from a **US mid-market multi-channel catalog retailer**, dated **8 September 2003**. A 23+ section RFP response spanning Executive Summary, Solution Summary, Product/Solution Functionality, Top-Line Business Objectives, Solution Support, Implementation + Team, Implementation Schedule, Investment/Pricing, Company Overview, References/Qualifications, and a Merchandise Planning & Execution Process Overview.

**Deployment archetype:** US multi-channel retailer (catalog + web + retail) in the $500M–$1B revenue tier, aiming to grow to $1B "leading multi-channel retailer known for superior products, values, customer experience, operations and profitability." Evant proposed a phased implementation of their Retail Management suite to support that goal.

## The Evant Retail Management Suite

Three workflow components, presented as an integrated suite:

1. **Evant Merchandising** — transaction management including purchasing, pricing, inventory management. *Not proposed for this client.*
...
| Evant Decision Support | Data models for catalog/web/product/inventory/selling, integrated into the client's BI tool (MicroStrategy, Oracle Express, etc.) | ✅ |
...
Notable for GrowDirect / Canary lineage: Evant's pitch of "centralized system of record repository for retail enterprise data that drives reporting" is conceptually the same value proposition as Canary's CRDM (Canary Retail Data Model) — a master dataset that unifies merchandising, location, channel, and product information. The difference is **2026 merchants get this automatically over OAuth from their POS; 2003 mid-market catalog retailers got it as a multi-million-dollar integration project.**

The specific 2003 prospective client in this archive filed for bankruptcy in 2008 and ceased operations as a standalone business — a reminder that in retail, even the best merchandising technology doesn't save a declining business model.
...
- [[Brain/wiki/secure-retail-operating-model-2006|Retail Operating Model (2006)]] — later operating-model work
...
- `Brain/raw/inbox/Merchandising System RFP - Evant Response-working.doc` — Evant's response to the RFP, 8 Sept 2003
