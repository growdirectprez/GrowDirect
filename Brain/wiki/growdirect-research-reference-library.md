...
date: 2026-04-22
type: wiki
tags: [growdirect, research, reference-library]
sources:
  - docs/_archive/ip-vault/Canary_Reference_Library_v1.0.md
...
- `docs/_archive/ip-vault/Canary_Reference_Library_v1.0.md` — the source doc this card summarizes
