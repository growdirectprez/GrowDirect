...
**Companion cards.** `canary-module-m-functional-decomposition.md` (M.2 tier identity, M.3 loyalty + AR — M inherits both), `garden-center-operating-reality.md` (landscaper / wholesale / project-tier vertical reality).
...
**Companion cards.** `canary-module-m-functional-decomposition.md` (M.3 loyalty + AR), `canary-module-f-functional-decomposition.md` (F.6 AR ledger — M.3 below is the cross-cut).
...
- `canary-module-m-functional-decomposition.md` — sister card; M inherits M.2 (tier identity) and M.3 (loyalty + AR); R is M's primary substrate dependency
