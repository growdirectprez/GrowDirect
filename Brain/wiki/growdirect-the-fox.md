...
date: 2026-04-22
type: wiki
tags: [growdirect, warchest, fox, case-management, evidence]
sources:
  - docs/_archive/ip-vault/warchest/sources/45-the-fox.md
...
- `docs/_archive/ip-vault/warchest/sources/45-the-fox.md` — the war-chest source this card summarizes
