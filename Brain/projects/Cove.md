...
| [[Brain/wiki/cove-csudh-field-guide|CSUDH Field Guide (McNulty 2012)]] | Academic geology source document for the PV landslide complex |
| [[Brain/wiki/cove-1976-pvp-development-pressure|1976 PV Properties Development Pressure]] | Historic news clipping — the 50-year pattern of development pressure at Abalone Cove |
| [[Brain/wiki/cove-governance|Governance & Operations]] | WPBCA structure, 501(c)(3) strategy, 90-day action plan |
| [[Brain/wiki/coac-bylaws-moc|CoAC Bylaws MOC]] | 2012 Bylaws vs 2009 Restated Declaration — 2026 compliance gap — proposed 2026 bylaws — successor Restated Declaration |
| [[Brain/wiki/cove-document-retention|Document Retention]] | What records the association must keep, for how long, and member inspection rights |
...
| [[Brain/wiki/cove-declaration-100-scope-open|Declaration 100 Scope — Open Question]] | Page 155 illegibility; boundary not settled; Foundation's archival research mandate |
...
| Article | What it covers |
|---------|---------------|
| [[Brain/wiki/cove-arc-posture|ARC Posture — Concierge + Transparency]] | Settled posture: city permits, ARC helps members through the city's process; not reviewer |
| [[Brain/wiki/cove-art-jury-vs-wpbca-arc|Art Jury vs. WPBCA ARC]] | 1929 Art Jury (Dec. 100, AIA-staffed, binding) vs. 2012 Bylaws ARC (3 appointees, Davis-Stirling process) — what the module should operationalize |
| [[Brain/wiki/seacove-arc-module|Seacove ARC Module]] | Cove ARC module design |
...
Durable, cross-cutting articles that answer operational questions. Built 2026-04-19 from the annotated source documents below.

| Article | What it covers |
|---------|---------------|
| [[Brain/wiki/cove-rpv-planning-framework-2026|RPV Planning Framework — What Controls WPBCA (2026)]] | GP + HE + Safety Element synthesized into one current operational picture; 5 things the 2018 framework changes for ARC review; moratorium/BR tension |
| [[Brain/wiki/cove-case-law-lessons|Case-Law Synthesis — Rules That Bind WPBCA]] | 19 rules covering CC&R enforceability, inverse condemnation (Albers), landslide (Monks), takings, transparency; active filings; contradictions flagged |
| [[Brain/wiki/cove-endangered-species-constraints|Endangered Species Constraints — Species → Trigger → Project Map]] | Operational decision tool: for a given scope of work, which listed species, which regulatory trigger, which consultation obligation |
| [[Brain/wiki/cove-lessons-learned|Cove Lessons Learned Ledger]] | Running dense ledger organized by domain (governance, permits, legal, land use, habitat, community) |
...
| [[Brain/wiki/cove-rpv-safety-element-2018|2018 RPV Safety Element]] | Current hazard element; Palos Verdes Fault MMI XI baseline; Landslide Inventory (Fig 3); Fire Hazard Severity Zone (Fig 1); validates Dec. One-A 40-ft bluff setback |
