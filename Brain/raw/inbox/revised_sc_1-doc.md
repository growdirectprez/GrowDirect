...
date: 2026-04-24
type: raw
source: Brain/raw/.extract/SWINDON/Revised_Sc_1.doc.md
...
## Source
File: `Brain/raw/.extract/SWINDON/Revised_Sc_1.doc.md`
Size: 6,651 bytes

## Raw content
Cindy and Frank are on a temporary work assignment in the UK; they are getting married and have decided to register with the T&K bridal registry.  They visit  the T&K gift registry which has recently become available on-line to select their gifts and inform their guests they have registered.N/A HYPERLINK "http://www.macys.com" www.macys.com
...
Cindy’s uncle Bob reciees an e-mail from T&K informing him that Cindy and Bob hjave recently registered for their wedding. He decides to make a purchase from their registry, and follows a link from the e-mail to the T&K website for Bob & Cindy’s wedding.  Bob is in a hurry to shop, is looking for a specific product from the registry and is not concerned about providing personal information1.1
...
Bgob browses throught eh registry listing, where he is able to view product details of the items Frak and Coo ndy registered for.  He can also see the quantity they requeste, and the quantity already purchased. Bob decides to purchase a set of the china for which Cindy has registered.  He selects the item, and adds it to his shopping basket.
...
Bob proceeds to his shopping cart page where he is able to increase the quantity of his order to two place settings.
...
Applet
AP1:  Shopping assistant for registry purchases, local inventory via postal/zip code entry, gift messages and gift cards
Bob types a message in the space provided.  The message is printed on a gift card to be enclosed with the gift.  The assistant also asks Bob if he would like to be reminded in regular intervals of the occasion for which he gave the gift.  He chooses annual reminders to be sent to his email address on the 15th of the month and calls it “Frank and Cindy’s Anniversary”.1.7
...
After the sales transaction is complete, Frank and Cindy’s registry is updated to reflect the sale.  Bob is sent a confirmation e-mail and url to track the status of his order online, Frank and Cindy receive an e-mail to inform them of Bob’s purchase, and when they should expect it to arrive
N/AConfirmation page HYPERLINK "http://www.crateandbarrel.com" www.crateandbarrel.com
...
Customer Storyboard	Slide	 Slide Elements 	Example Website 	BroadVision Features 	Custom / Enhancement
	...
	Scenario 1: Uncle Bob	Page  PAGE 3 of  NUMPAGES 3
