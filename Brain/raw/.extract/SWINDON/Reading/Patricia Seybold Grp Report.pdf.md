...
Product Review (cid:127) 9
| Product Plans |     |     |     | Competition |     |     |     |
| ------------- | --- | --- | --- | ----------- | --- | --- | --- |
BroadVision offered us little specific detail on One-To-One Commerce faces competition from
future versions of One-To-One Commerce. Instead other e-commerce server products as well as from
the company provided some high-level indications custom-developed  approaches  implemented  inter-
of product directions including: nally  or  through  consulting  services.  Among  the
(cid:127)  Adding packaged commerce functionality competing e-commerce servers, IBM Net.Commerce
and Microsoft Site Server Commerce Edition are the
(cid:127)  Extending and simplifying application and site market share leaders. Both products carry software
maintenance
license fees lower by an order of magnitude than
One-To-One Commerce, but neither product pack-
| Automating         | repetitive  ad- |     |     |     |                |            |              |
| ------------------ | --------------- | --- | --- | --- | -------------- | ---------- | ------------ |
| (cid:127)          |                 |     |     |     | ages  the      | level      | of  packaged |
| ministrative tasks |                 |     |     |     | functionality  | offered    | by  One-     |
|                    |                 |     |     |     | To-One         | Commerce.  | Note  that   |
(cid:127)  Improving distributed proc- InterWorld Commerce Exchange Net.Commerce  offers  superior
essing capabilities is perhaps the closest competitor capabilities  for  integrating  ex-
|     |     | to One-To-One Commerce in |     |     | ternal applications. On the other |     |     |
| --- | --- | ------------------------- | --- | --- | --------------------------------- | --- | --- |
(cid:127)  Improving integration with hand,  One-To-One  Commerce
price, capabilities, and target
external applications
does not scale down in cost and
|        |                     |     | market. |     | simplicity       | to  address  | low-end      |
| ------ | ------------------- | --- | ------- | --- | ---------------- | ------------ | ------------ |
| While  | more  detail  would |     |         |     |                  |              |              |
|        |                     |     |         |     | and  mid-market  |              | requirements |
have been preferable, this is a
|     |     |     |     |     | that  are  | well  addressed  | by  |
| --- | --- | --- | --- | --- | ---------- | ---------------- | --- |
good list, and we certainly hope
Net.Commerce and Commerce Server.
to see these improvements soon. They address limi-
InterWorld Commerce Exchange is perhaps the
| tations  that  | we’ve  identified  | with  One-To-One |     |                      |                 |           |     |
| -------------- | ------------------ | ---------------- | --- | -------------------- | --------------- | --------- | --- |
|                |                    |                  |     | closest  competitor  | to  One-To-One  | Commerce  | in  |
Commerce.
|     |     |     |     | price,  capabilities,  | and  target  | market.  | Commerce |
| --- | --- | --- | --- | ---------------------- | ------------ | -------- | -------- |
Exchange lacks the breadth and depth of marketing
Pricing
functionality provided by One-To-One Commerce.
BroadVision did not provide pricing details on Its personalization is based on predefined groups and
|     |     |     |     | some  fundamental  | merchandising  | capabilities  | are |
| --- | --- | --- | --- | ------------------ | -------------- | ------------- | --- |
One-To-One Commerce, but the firm told us that its
average  customer  pays  $360,000  for  software  li- not supported. But the product offers comparable
censes. Installations should expect to spend another shopping, buying, and fulfillment. Its process orien-
|     |     |     |     | tation  provides  | good  flexibility  | for  | implementing |
| --- | --- | --- | --- | ----------------- | ------------------ | ---- | ------------ |
$150,000 to $250,000 on consulting services to im-
plement the product. buying and fulfillment processes that reflect instal-
|             |                    |                |      | lation  requirements.  | Commerce  | Exchange  | is  de- |
| ----------- | ------------------ | -------------- | ---- | ---------------------- | --------- | --------- | ------- |
| One-To-One  | carries  a  price  | but  delivers  | good |                        |           |           |         |
value.  It  offers  strong  e-commerce  functionality ployed on a proprietary but innovative infrastructure,
that’s implemented on a rich and robust infrastruc- although  its  platform  and  database  support  are
somewhat limited.
ture. Expect to spend at least $500,000 just to im-
plement a substantial e-commerce site independently
| of the server that you select. There can be significant |     |     |     | VIABILITY |     |     |     |
| ------------------------------------------------------- | --- | --- | --- | --------- | --- | --- | --- |
advantages in time to market and ongoing mainte-
nance when you buy packaged capabilities like those There  are  no  viability  risks  with  One-To-One
Commerce. The product is in its fourth major ver-
of One-To-One Commerce as compared with buying
consulting services to customize and extend “less sion. Its capabilities have been steadily improved,
addressing market requirements and reflecting inno-
expensive” e-commerce servers.
vation on the part of BroadVision. With 150 instal-
lations, including American Airlines, Circuit City,
and Home Depot, it’s widely used and well proven.
One-To-One Commerce is one of three applications
© 1999 Patricia Seybold Group’s E-Business Strategies & Solutions

10 (cid:127) One-To-One Commerce 4.1
| offered by the firm. The other two are One-To-One |     |     |     |     | CONCLUSION |     |     |     |
| ------------------------------------------------- | --- | --- | --- | --- | ---------- | --- | --- | --- |
Financial, a banking, financial services, and insur-
|     |     |     |     |     | One-To-One  | Commerce  | is  an  electronic  | com- |
| --- | --- | --- | --- | --- | ----------- | --------- | ------------------- | ---- |
ance application, and One-To-One Knowledge, an
merce server that combines rich functionality across
| information  | distribution  | application.  |     | To  date, |     |     |     |     |
| ------------ | ------------- | ------------- | --- | --------- | --- | --- | --- | --- |
marketing, shopping, buying, and fulfillment proc-
| BroadVision  | has  300  | One-To-One  | customers,  | in- |     |     |     |     |
| ------------ | --------- | ----------- | ----------- | --- | --- | --- | --- | --- |
esses with an architecture that offers good scalability
cluding the 150 One-To-One Commerce customers.
and both customization and integration of external
| There are  | no  company  | viability  | issues,  | either, |                |                |               |           |
| ---------- | ------------ | ---------- | -------- | ------- | -------------- | -------------- | ------------- | --------- |
|            |              |            |          |         | applications.  | It  has  been  | widely  used  | and  well |
unless dealing with a large, mature company is the
proven in large-scale B2C installations. New capa-
way that you prefer to do business. BroadVision is a
bilities make it attractive for B2B applications.
publicly held company (NASDAQ: BVSN) founded
in 1993. Headquartered in Redwood City, Califor-
Contact
nia,  the  firm  currently  employs  300  individuals. BroadVision, Inc.
| From  a  | financial  perspective,  | BroadVision  |     | turned | 585 Broadway |     |     |     |
| -------- | ------------------------ | ------------ | --- | ------ | ------------ | --- | --- | --- |
Redwood City, CA 94063
profitable in 2Q98. For its 1998 fiscal year, revenues
David Andrews
were $50.9 million and net income was $4.0 million.
Director of Product Management E-Commerce Group
At this point in its corporate lifecycle, while it’s still Phone: 650.261.5920
Fax: 650.261.5900
a young company, it has moved on from a startup
E-Mail: dandrews@broadvision.com
| stage  to a  | growth stage.  | Its  next  | challenge  | is  to |     |     |     |     |
| ------------ | -------------- | ---------- | ---------- | ------ | --- | --- | --- | --- |
Internet: www.broadvision.com
broaden its markets and increase its sales volume.
© 1999 Patricia Seybold Group’s E-Business Strategies & Solutions