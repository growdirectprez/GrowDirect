...
Interface Specification C003US
Sub Department details from RMS to the Integration Layer
...
Table of Contents
 TOC \o "1-3" \t "Appendix,1" 1	Introduction	 PAGEREF _Toc155511239 \h 3
1.1	Purpose of Document	 PAGEREF _Toc155511240 \h 3
1.2	Background	 PAGEREF _Toc155511241 \h 3
1.3	Scope	 PAGEREF _Toc155511242 \h 3
2	Description and Requirements for the End-to-End Interface	 PAGEREF _Toc155511243 \h 4
2.1	Description of the End-to-End Interface	 PAGEREF _Toc155511244 \h 4
2.2	Requirements for the End-to-End Interface	 PAGEREF _Toc155511245 \h 4
3	Processing Required from RMS	 PAGEREF _Toc155511246 \h 6
3.1	Scope	 PAGEREF _Toc155511247 \h 6
3.2	Source Message Schema	 PAGEREF _Toc155511248 \h 6
3.3	Message Transport Details	 PAGEREF _Toc155511249 \h 6
4	Processing Required in the Integration Layer	 PAGEREF _Toc155511250 \h 8
4.1	Scope	 PAGEREF _Toc155511251 \h 8
4.2	Data Validation	 PAGEREF _Toc155511252 \h 8
4.3	Filtering	 PAGEREF _Toc155511253 \h 8
4.4	Mapping	 PAGEREF _Toc155511254 \h 8
4.5	Target Message Schema	 PAGEREF _Toc155511255 \h 8
4.6	Message Transport Details	 PAGEREF _Toc155511256 \h 8
5	Assumptions and Outstanding Issues	 PAGEREF _Toc155511257 \h 9
5.1	Assumptions	 PAGEREF _Toc155511258 \h 9
5.2	Outstanding Issues	 PAGEREF _Toc155511259 \h 9
Appendix A Volumes	 PAGEREF _Toc155511260 \h 10
Appendix B Glossary	 PAGEREF _Toc155511261 \h 11
Appendix C Document Control	 PAGEREF _Toc155511262 \h 12
...
Background
The purpose of the interface is to receive sub department merchandise hierarchy details from Oracle Retail Management System (RMS) via the Retail Integration Bus (RIB). These messages will be mapped to the Tesco common form and copied to the Integration Data Store (IDS). A sub department is made up of RMS Class and Sub Class.
Scope
...
This interface is the transmission of sub department (class and subclass) merchandise hierarchy details from RMS to the integration layer then onto the store.
...
Scope
The message will be produced by the Oracle Retail Management System and published on the Retail Integration Bus (RIB) using Java Messaging Service (JMS). 

The messages will take one of four forms, MrchHrClsRef, MrchHrClsDesc, MrchHrSclsRef or MrchHrSclsDesc. MrchHrClsRef is created when a class is deleted and MrchHrClsDesc is generated on insert or update of a class. MrchHrSclsRef is created when a subclass is deleted and MrchHrSclsDesc is generated on insert or update of a subclass. The messages will belong to groups, known as families in JMS. The RIB message type will specify the operation performed and are as follows:
classcre – Creation
classmod - Update
classdel – Deletion
subclasscre – Creation
subclassmod - Update
subclassdel - Deletion
...
The message is uniquely identified by the RIB Message ID. The message can either be of the form MrchHrClsRef, MrchHrClsDesc, MrchHrSclsRef or MrchHrSclsDesc. Both message formats are XML and the schemas can be found in .\MrchHrClsDesc.xsd, .\MrchHrClsRef.xsd, .\MrchHrSclsDesc.xsd and .\MrchHrSclsRef.xsd.
...
Scope
When the class or subclass details are received by the integration layer, these details will be mapped to the Tesco common form and stored in the integration data store.
Data Validation
...
The common form schema for Items can be found in .\Class.xsd and .\SubClass.xsd.
Message Transport Details 
