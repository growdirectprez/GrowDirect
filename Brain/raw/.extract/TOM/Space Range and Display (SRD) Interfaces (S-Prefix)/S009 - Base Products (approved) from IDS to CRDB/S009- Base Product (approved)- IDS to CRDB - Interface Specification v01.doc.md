...
S009 Information Context Diagram - Base Product(approved) Information.vsd

Mapping spreadsheet
S009- Base Products(approved) - IDS to CRDB Mappings.xls

Other Reference Documents
Interface 080 Product Description v3.1.doc
Table of Contents
 TOC \o "1-3" \t "Appendix,1" 1	Introduction	 PAGEREF _Toc165179140 \h 6
1.1	Purpose of Document	 PAGEREF _Toc165179141 \h 6
1.2	Background	 PAGEREF _Toc165179142 \h 6
1.3	Scope	 PAGEREF _Toc165179143 \h 6
2	Description and Requirements for the End-to-End Interface	 PAGEREF _Toc165179144 \h 7
2.1	Description of the End-to-End Interface	 PAGEREF _Toc165179145 \h 7
2.2	Architecture	 PAGEREF _Toc165179146 \h 7
2.3	Requirements of the End-to-End Interface	 PAGEREF _Toc165179147 \h 7
2.4	Non-Functional Requirements of the End-to-End Interface	 PAGEREF _Toc165179148 \h 8
3	Processing Required in the Extract Stage of the Interface	 PAGEREF _Toc165179149 \h 9
3.1	Scope	 PAGEREF _Toc165179150 \h 9
3.2	Source Message Schema	 PAGEREF _Toc165179151 \h 9
3.3	Message Transport Details	 PAGEREF _Toc165179152 \h 9
4	Processing Required in the SSIS Stage of the Interface	 PAGEREF _Toc165179153 \h 10
4.1	Scope	 PAGEREF _Toc165179154 \h 10
4.2	Package Overview	 PAGEREF _Toc165179155 \h 10
4.3	Data Validation	 PAGEREF _Toc165179156 \h 10
4.4	Filtering	 PAGEREF _Toc165179157 \h 10
4.5	Mapping	 PAGEREF _Toc165179158 \h 10
4.6	Target Message Schema	 PAGEREF _Toc165179159 \h 10
4.7	Message Transport Details	 PAGEREF _Toc165179160 \h 11
4.8	Naming and Configuration	 PAGEREF _Toc165179161 \h 11
4.9	Environment and Security Context	 PAGEREF _Toc165179162 \h 12
4.10	Non-Functional Requirements	 PAGEREF _Toc165179163 \h 12
5	Processing required in the <third stage of the interface>	 PAGEREF _Toc165179164 \h 13
5.1	Scope	 PAGEREF _Toc165179165 \h 13
5.2	Data Validation	 PAGEREF _Toc165179166 \h 13
5.3	Filtering	 PAGEREF _Toc165179167 \h 13
5.4	Mapping	 PAGEREF _Toc165179168 \h 13
5.5	Target Message Schema	 PAGEREF _Toc165179169 \h 13
5.6	Message Transport Details	 PAGEREF _Toc165179170 \h 13
5.7	Naming and Configuration	 PAGEREF _Toc165179171 \h 13
5.8	Environment and Security Context	 PAGEREF _Toc165179172 \h 13
5.9	Non-Functional Requirements	 PAGEREF _Toc165179173 \h 13
6	Testing Deliverables	 PAGEREF _Toc165179174 \h 14
7	Deployment	 PAGEREF _Toc165179175 \h 15
8	Assumptions and Outstanding Issues	 PAGEREF _Toc165179176 \h 16
8.1	Assumptions	 PAGEREF _Toc165179177 \h 16
8.2	Outstanding Issues	 PAGEREF _Toc165179178 \h 16
Appendix A Volumes	 PAGEREF _Toc165179179 \h 17
Appendix B Glossary	 PAGEREF _Toc165179180 \h 18
Appendix C Document Control	 PAGEREF _Toc165179181 \h 19

Introduction
Purpose of Document
The purpose of this document is to describe the interfacing requirements w.r.t Base Products (approved) data between the IDS to CRDB. The document is of a sufficiently technical nature to allow a developer to build an actual interface. Additionally the document contains detail that might sit logically within a Technical System Design (TSD) document, but is contained here for expediency. There is therefore no associated TSD for this interface. 

This interface is for both US and Turkey implementations.

Background
As part of Tesco Operating Model program, there is requirement to bridge the functionalities of enterprise applications including IDS and CRDB. To achieve this functionality, high level process flow architecture has been designed and approved by Tesco’s Enterprise Architecture team. As part of this process flow architecture there is a set of interfaces that has been identified to be developed to transfer Base Products (approved) data from IDS into CRDB.
Scope
...
The interface is an extract of Base Products (approved) Data from IDS using Common Forms and uploads into the CRDB as positional Flat file. This interface will be delta upload in nature.

The interface is dealing with transfer of Base Products (approved) Data from IDS to CRDB. The resulting format is a positional flat file. The format of this file will be as defined by the existing UK SRM Interface specification number 080. 

The target shared locations will be put in a configuration state so that while in implementation this can be changed as per the requirement.
...
The interface is meant to run nightly at a pre-configured time which on completion is expected to upload the Base Products (approved) Data in a Flat file into CRDB shared directory.
...
The data for this interface resides in the IDS. Common Form Service TOM.Common.Schema.Item  is called by the SSI package to extract the Base Product (approved) data. The services are exposed as stored procedures and return row sets representing Base Product in the Item Common Form. 
...
Package Overview
SSIS extracts the Base Product (approved) data from IDS using Common Forms, nightly at predefined time.  In turn, the data is formatted as per the below layouts file structure and uploaded same into the CRDB allocated inbox shared directory.
Data Validation
N/A
Filtering
...
Alphanumeric
2
Set to '01' for the detail record.
TPNB
Numeric
9
SKU Item ID 
...
Alphanumeric
10
this will count data records only. The number will contain leading zeros.
...
SSIS
Package Name: TOM_IDSCRDB_BaseProduct_approved_pkg

Name
IDSCRDBBaseProductApproved
...
Version 0.1, Issue  REF DOC_STATUS Draft	Page:  PAGE  \* MERGEFORMAT 20 of  NUMPAGES 19	Date:  SAVEDATE \@ "d MMM yyyy" 24 Apr 2007
