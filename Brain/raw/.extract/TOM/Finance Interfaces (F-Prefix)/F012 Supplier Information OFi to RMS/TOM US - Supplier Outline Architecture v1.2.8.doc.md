...
The transmission technology will be XCOM [Assumption] or CIFS [Assumption].
...
A parallel process is created to make copies of the Common Forms and to pass them to the RTI Database Command Script adpater which will write the records to the IDS. 
...
5
Transmit the File [Application Project]
28/03/2007
L
0.5
S
...
A definitive specification of the extract needed is givn in the BSD.
The Extract Script
...
Version  DOCPROPERTY "Doc Version"  \* MERGEFORMAT 1.0 REF DOC_STATUS 	Page:  PAGE  \* MERGEFORMAT iv of  NUMPAGES 46	Date:  SAVEDATE \@ "d MMM yyyy" 27 Feb 2007
...
Version  DOCPROPERTY "Doc Version"  \* MERGEFORMAT 1.0 REF DOC_STATUS 	Page:  PAGE  \* MERGEFORMAT 21 of  NUMPAGES 46	Date:  SAVEDATE \@ "d MMM yyyy" 27 Feb 2007
...
Version  DOCPROPERTY "Doc Version"  \* MERGEFORMAT 1.0 REF DOC_STATUS 	Page:  PAGE  \* MERGEFORMAT 24 of  NUMPAGES 46	Date:  SAVEDATE \@ "d MMM yyyy" 27 Feb 2007
