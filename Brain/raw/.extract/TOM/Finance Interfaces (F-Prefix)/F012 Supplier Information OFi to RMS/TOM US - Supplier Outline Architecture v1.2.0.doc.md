...
Fields should be comma delimited.	 PAGEREF _Toc157915099 \h 14
Records should end with CR.	 PAGEREF _Toc157915100 \h 14
A.2	Common Form Schema	 PAGEREF _Toc157915101 \h 14
A.3	OFi Source Data	 PAGEREF _Toc157915102 \h 15
A.4	RIB RMS message format	 PAGEREF _Toc157915103 \h 27
A.5	Mapping	 PAGEREF _Toc157915104 \h 34
...
(Note: The Supplier IDS is for use by other systems that need supplier information. It will also be used by the Approved Payments interface so that the messages coming from ReIM to OFi can have the Supplier_Id overwriiten with the Vendor_Id by means of a SQL lookup functoid).
...
1
S
Extract Vendors and Vendor Sites  Output a combined record for every site as a comma delimited flat file.
3
Schedule Extracts
28/03/2007
L
...
Fields should be comma delimited.
...
NOTESOFIPO_VENDORS“VENDOR_ID” (from SEGMENT1)6 NUMBER Held in IDSOFIPO_VENDOR_SITES_ALL“VENDOR_SITE_ID” (from ATTRIBUTE10)5 NUMBER ORMS
...
Version  DOCPROPERTY "Doc Version"  \* MERGEFORMAT 1.0 REF DOC_STATUS 	Page:  PAGE  \* MERGEFORMAT ii of  NUMPAGES 39	Date:  SAVEDATE \@ "d MMM yyyy" 24 Jan 2007
...
Version  DOCPROPERTY "Doc Version"  \* MERGEFORMAT 1.0 REF DOC_STATUS 	Page:  PAGE  \* MERGEFORMAT 15 of  NUMPAGES 39	Date:  SAVEDATE \@ "d MMM yyyy" 24 Jan 2007
...
Version  DOCPROPERTY "Doc Version"  \* MERGEFORMAT 1.0 REF DOC_STATUS 	Page:  PAGE  \* MERGEFORMAT 39 of  NUMPAGES 39	Date:  SAVEDATE \@ "d MMM yyyy" 24 Jan 2007
