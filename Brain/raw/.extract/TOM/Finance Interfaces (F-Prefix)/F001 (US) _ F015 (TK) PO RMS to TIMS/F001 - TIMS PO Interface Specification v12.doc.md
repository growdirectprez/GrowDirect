...
23-Feb-2007
1.01
Change Request for addition of EOL delimiter. Modification in Common forms
Sankar G
26-Feb-2007
1.02
Modified after review comments from Tom Harper
Sankar G
08-Mar-2007
1.03
Correction in Source Message schema for RMS 10 EDI format.
Sankar G
09-Mar-2007
1.04
Modification made based on the undocumented EDIDLORD process running in Turkey
...
F015 - Information Context Diagram - PO (RMS to TIMS) Turkey

Mapping spreadsheet
F015 - Purchase Order mapping document (turkey) v70.xls
F001 - Purchase Order mapping document (US).xls
Table of Contents
...
3.3	Message Transport Details	 PAGEREF _Toc156118530 \h 19
3.4	Naming and Configuration	 PAGEREF _Toc156118531 \h 20
3.5	Environment and Security Context	 PAGEREF _Toc156118532 \h 20
3.6	Non-Functional Requirements	 PAGEREF _Toc156118533 \h 20
4	Processing required in the Messaging Stage of the interface	 PAGEREF _Toc156118534 \h 21
4.1	Scope	 PAGEREF _Toc156118535 \h 21
4.2	Data Validation	 PAGEREF _Toc156118536 \h 21
4.3	Filtering	 PAGEREF _Toc156118537 \h 21
4.4	Mapping	 PAGEREF _Toc156118538 \h 21
4.5	Target Message Schema	 PAGEREF _Toc156118539 \h 22
4.6	Sample Target Message	 PAGEREF _Toc156118540 \h 23
4.7	Message Transport Details	 PAGEREF _Toc156118541 \h 23
4.8	Naming and Configuration	 PAGEREF _Toc156118542 \h 24
4.9	Environment and Security Context	 PAGEREF _Toc156118543 \h 25
4.10	Non-Functional Requirements	 PAGEREF _Toc156118544 \h 25
5	Processing required in the <third stage of the interface>	 PAGEREF _Toc156118545 \h 26
5.1	Scope	 PAGEREF _Toc156118546 \h 26
5.2	Data Validation	 PAGEREF _Toc156118547 \h 26
5.3	Filtering	 PAGEREF _Toc156118548 \h 26
5.4	Mapping	 PAGEREF _Toc156118549 \h 26
5.5	Target Message Schema	 PAGEREF _Toc156118550 \h 26
5.6	Message Transport Details	 PAGEREF _Toc156118551 \h 26
5.7	Naming and Configuration	 PAGEREF _Toc156118552 \h 26
5.8	Environment and Security Context	 PAGEREF _Toc156118553 \h 26
5.9	Non-Functional Requirements	 PAGEREF _Toc156118554 \h 26
6	Testing Deliverables	 PAGEREF _Toc156118555 \h 27
7	Deployment	 PAGEREF _Toc156118556 \h 28
8	Assumptions and Outstanding Issues	 PAGEREF _Toc156118557 \h 29
8.1	Assumptions	 PAGEREF _Toc156118558 \h 29
8.2	Outstanding Issues	 PAGEREF _Toc156118559 \h 29
Appendix A Volumes	 PAGEREF _Toc156118560 \h 30
Appendix B Glossary	 PAGEREF _Toc156118561 \h 31
Appendix C Document Control	 PAGEREF _Toc156118562 \h 32
...
This document is for US and Turkey implementations. Turkey RMS 10.7 is in operation. In US RMS 12 will be in operation. The EDI download file is different in these two locations. So, two mapping documents will be prepared. Two different source codes will be written.
...
Record NameField NameField TypeLengthStart PositionEnd PositionDefault Value / OccursDescriptionFHEAD
...
End Sub Sub-Group AAAEnd Sub Sub-Group AAAEnd Sub-Group AAEnd Sub-Group AATTAIL
Record type
Char(5)
5
1
...
In this context, some of the source data being database tables, the source message is generated with the combination of data from the tables.
...
Service Name
Description
TOM.C008ORMS.Schema.Supplier
This is a stored procedure (SP). This SP will Fetch the supplier information from Supplier table on IDS independently. This store procedure is capable of returning Row-sets. This SP will return supplier information in XML format.
Version of the store procedure is 1.0  
TOM.Common.Schema.Store
This is a stored procedure (SP). This SP will Fetch the Store (Branch) information from Supplier table on IDS based on input parameters. This store procedure will return a row based on input parameters. This SP will return supplier information in XML format.
Version of the store procedure is 1.0  
TOM.Common.Schema.Warehouse
This is a stored procedure (SP). This SP will Fetch the Warehouse (DC) information from Supplier table on IDS based on input parameters. This store procedure will return a row based on input parameters. This SP will return supplier information in XML format.
Version of the store procedure is 1.0  

Sample Source Message
The source message is line terminated with line feed.
...
Version  REF DOC_VER Error! Reference source not found., Issue  REF DOC_STATUS Error! Reference source not found.	Page:  PAGE  \* MERGEFORMAT 11 of  NUMPAGES 33	Date:  SAVEDATE \@ "d MMM yyyy" 13 Mar 2007
