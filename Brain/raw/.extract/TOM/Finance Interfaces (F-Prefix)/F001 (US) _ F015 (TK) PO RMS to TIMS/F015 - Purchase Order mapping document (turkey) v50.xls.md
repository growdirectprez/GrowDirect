...
| NaN | Target File Name: ? | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | Maps | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN |
...
| NaN | NaN | NaN | Supplier | SupplierName | Nvarchar(80) | Y | Locate TORDR.Supplier in Supplier table and pickup the SupplierName | NaN | NaN | NaN | NaN | PO Header | 10 | NaN | ADRRAIS | CHAR(35) | NaN | NaN | NaN | Common Form Name: TOM.C008ORMS.Schema.Supplier\nInput Parameter: TORDR.Supplier\nOutput field: SupplierName |
| NaN | NaN | NaN | Address | AddrLine1 | Nvarchar(240) | Y | Locate TORDR.Supplier in Supplier table and pickup the AddressID. \nWith Supplier.AddressID locate in Address table and Pickup the AddrLine1. | NaN | NaN | NaN | NaN | PO Header | 11 | NaN | ADRRUE1 | CHAR(35) | NaN | NaN | NaN | Common Form name: TOM.Common.Schema.Address\nInput Parameter: TOM.C008ORMS.Schema.Supplier.AddressID\nOutput field: AddrLine1 |
| NaN | NaN | NaN | Address | AddrLine2 | Nvarchar(240) | Y | Locate TORDR.Supplier in Supplier table and pickup the AddressID. \nWith Supplier.AddressID locate in Address table and Pickup the AddrLine2. | NaN | NaN | NaN | NaN | PO Header | 12 | NaN | ADRRUE2 | CHAR(35) | NaN | NaN | NaN | Common Form name: TOM.Common.Schema.Address\nInput Parameter: TOM.C008ORMS.Schema.Supplier.AddressID\nOutput field: AddrLine2 |
| NaN | NaN | NaN | Address | City | Nvarchar(120) | Y | Locate TORDR.Supplier in Supplier table and pickup the AddressID. \nWith Supplier.AddressID locate in Address table and Pickup the City. | NaN | NaN | NaN | NaN | PO Header | 13 | NaN | ADRVILL | CHAR(35) | NaN | NaN | NaN | Common Form name: TOM.Common.Schema.Address\nInput Parameter: TOM.C008ORMS.Schema.Supplier.AddressID\nOutput field: City |
| NaN | NaN | NaN | Address | PostCode | Nvarchar(30) | Y | Locate TORDR.Supplier in Supplier table and pickup the AddressID. \nWith Supplier.AddressID locate in Address table and Pickup the PostCode. | NaN | NaN | NaN | NaN | PO Header | 14 | NaN | ADRCODE | CHAR(9) | NaN | NaN | NaN | Common Form name: TOM.Common.Schema.Address\nInput Parameter: TOM.C008ORMS.Schema.Supplier.AddressID\nOutput field: PostCode |
| NaN | NaN | NaN | Address | FaxNumber | Varchar(20) | Y | Locate TORDR.Supplier in Supplier table and pickup the AddressID. \nWith Supplier.AddressID locate in Address table and Pickup the FaxNumber. | NaN | NaN | NaN | NaN | PO Header | 15 | NaN | ADRTELC | CHAR(16) | N | NaN | NaN | Common Form name: TOM.Common.Schema.Address\nInput Parameter: TOM.C008ORMS.Schema.Supplier.AddressID\nOutput field: ContactFax |
| NaN | NaN | NaN | Address | PhoneNumber | Varchar(20) | Y | Locate TORDR.Supplier in Supplier table and pickup the AddressID. \nWith Supplier.AddressID locate in Address table and Pickup the PhoneNumber. | NaN | NaN | NaN | NaN | PO Header | 16 | NaN | ADRTELP | CHAR(16) | N | NaN | NaN | Common Form name: TOM.Common.Schema.Address\nInput Parameter: TOM.C008ORMS.Schema.Supplier.AddressID\nOutput field: ContactPhone |
| NaN | NaN | NaN | ISOCountry | ISOCountryName | Nvarchar(40) | Y | Locate TORDR.Supplier in Supplier table and pickup the AddressID. \nWith Supplier.AddressID locate in Address table and Pickup the ISOCountryCode.\nWith Address.ISOCountryCode locate in ISOCountry table and Piclup ISOCountryName. | NaN | NaN | NaN | NaN | PO Header | 17 | NaN | PARLIBL | CHAR(20) | NaN | NaN | NaN | Common Form name: TOM.Common.Schema.Address\nInput Parameter: TOM.C008ORMS.Schema.Supplier.AddressID\nOutput field: ISOCountryname |
...
| NaN | NaN | NaN | ISOCountry | ISOCountryName | Nvarcahr(40) | Y | If Location type = 'ST' then\n  Locate TSHIP.Ship to location in Store table\n  Where Quantity type flag ='S' and pickup AddressID\n  Locate Store.AddressID in Address table Pickup ISOCountryCode\n  Locate Address.ISOCountryCode in ISOCountry table Pickup ISOCountryName\nElse if Location type = 'WH' then\n  Locate TSHIP.Ship to location in Warehouse table\n  Where Quantity type flag ='S' and pickup AddressID\n  Locate Warehouse.AddressID in Address table Pickup ISOCountryCode\n  Locate Address.ISOCountryCode in ISOCountry table Pickup ISOCountryName | NaN | NaN | NaN | NaN | PO Header | 41 | NaN | PARLIBL\_LIVR | CHAR(20) | N | NaN | NaN | If Location type = 'ST' then\n  Common Form: TOM.Common.Schema.Address\n  Input Parameter: TOM.Common.Schema.Store.AddressID\n  Output field: ISOCountryName\nElse if Location type = 'WH' then\n  Common Form: TOM.Common.Schema.Address\n  Input Parameter: TOM.Common.Schema.Warehouse.AddressID\n  Output field: ISOCountryName |
