...
| NaN | NaN | NaN | Address | ISOCountryCode | Char(3) | Y | Locate TORDR.Supplier in Supplier table and pickup the AddressID. \nWith Supplier.AddressID locate in Address table and Pickup the ISOCountryCode. | NaN | NaN | NaN | NaN | PO Header | 17 | NaN | PARLIBL | CHAR(20) | NaN | NaN | NaN | Common Form name: TOM.Common.Schema.Address\nInput Parameter: TOM.C008ORMS.Schema.Supplier.AddressID\nOutput field: ISOCountryCode |
