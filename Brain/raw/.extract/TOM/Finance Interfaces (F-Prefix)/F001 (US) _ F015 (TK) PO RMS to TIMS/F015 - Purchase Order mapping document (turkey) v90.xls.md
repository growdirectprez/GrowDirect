...
| NaN | TSHIP,\nTSHIP | NaN | NaN | New Quantity,\nCase Weight | Number(12),\nNumber(12) | NaN | ARTPBRU = (New quantity / 10000 ) \* (Case Weight / 10000)\n                       group by TITEM.item | NaN | NaN | NaN | NaN | PO Items | 8 | NaN | ARTPBRU | NUMBER(8,3) | NaN | NaN | NaN | Filter quantity type "S" TSHIP record for every TITEM for a single TORDR. \n\nNew quantity / 10000  \nmultiplied by Case Weight / 10000\nwhere Quantity type flag = 'S'\ngroup by TITEM.item\n\nRound to 3 decimal places |
| NaN | TSHIP\nTITEM | NaN | NaN | New quantity, \nPack Size | Number(12)\nNumber(12) | NaN | DCOQTEC = (TSHIP.New unit cost / 10000) / (TITEM.Pack Size / 10000)\n                       group by TITEM.item | NaN | NaN | NaN | NaN | PO Items | 9 | NaN | DCOQTEC | NUMBER(9,3) | NaN | NaN | NaN | Filter quantity type "S" TSHIP record for every TITEM for a single TORDR. \n\nNew Quantity / 10000 \nDivided by Pack Size / 10000\nwhere Quantity type flag = 'S'\ngroup by TITEM.item\n\nRound to 3 decimal places |
...
| NaN | TSHIP\nTITEM | NaN | NaN | New unit cost\nPack Size | Number(20)\nNumber(12) | NaN | DCOPRIX = (TSHIP.New unit cost / 10000) \* (TITEM.Pack Size / 10000)\n                       group by TITEM.item | NaN | NaN | NaN | NaN | PO Items | 16 | NaN | DCOPRIX | NUMBER(11,3) | NaN | NaN | NaN | Filter Quantity type "S" TSHIP record for every TITEM for a single TORDR\n\nNew unit cost / 10000\nmultiplied by Pack Size / 10000\ngroup by TITEM.item\n\nRound to 3 decimal places\nNeed to get Pack Size from TITEM |
...
| 2007-10-04 00:00:00 | V9.0 | Sankar G | Change in Target file funcationalities. |
