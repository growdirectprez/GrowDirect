...
F013 - Information Context Diagram - PO Ack (TIMS to RMS)

Mapping spreadsheet
F013 - Purchase Order Acknowledgement mapping document
Table of Contents
...
Begin Group ’A‘
1:*
POACKItems will repeat multiple times under POACKHeader
PO ACK Items:
RECTYPE
...
1:*
TITEM will repeat multiple times under THEAD
TITEM
...
Version  REF DOC_VER 0.1, Issue  REF DOC_STATUS Draft	Page:  PAGE  \* MERGEFORMAT 22 of  NUMPAGES 23	Date:  SAVEDATE \@ "d MMM yyyy" 29 Jan 2007
