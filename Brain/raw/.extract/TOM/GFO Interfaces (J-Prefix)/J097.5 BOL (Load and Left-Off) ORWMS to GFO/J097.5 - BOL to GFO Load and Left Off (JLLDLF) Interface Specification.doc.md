...
Shipment notification (Bill of lading) to Storeline
[J097.5]
...
Mapping spreadsheet
J097.5 – BOL OL to GFO Mappings v1.xls
Table of Contents
...
5	Processing required in the RMS import stage of the interface	 PAGEREF _Toc153956194 \h 3
...
5.7	Environment and Security Context	 PAGEREF _Toc153956193 \h 15
...
Mapping
RIB ASN -> Common ASN -> LoadLeftOff.
The target flat file is called Load Left Off and specified in 4.5 Target Message Schema
...
12
X(12)
     03 JLLDA-RETAIL-OUTLET-NO
Int

5
9(5)
03 JLLDA-DEL-STK-CTR-NO
Int

5
9(5)
     03 JLLDA-RECEIPT-NOTE-NO
String

6
X(6)
     03 JLLDA-LOAD-CLOSED-DATE
Int

8
9(8)
     03 JLLDA-LOAD-CLOSED-TIME
Int

6
9(6)
     03 JLLDA-EST-DEL-DATE
Int

8
9(8)
     03 JLLDA-EST-DEL-TIME
Int
...
Load Left Off
Expected GFO file
Notification of lorry leaving and products not on lorry
SKU
Stock Keeping Unit
...
Version  REF DOC_VER 0.1, Issue  REF DOC_STATUS Draft	Page:  PAGE  \* MERGEFORMAT 12 of  NUMPAGES 21	Date:  SAVEDATE \@ "d MMM yyyy" 23 Feb 2007
