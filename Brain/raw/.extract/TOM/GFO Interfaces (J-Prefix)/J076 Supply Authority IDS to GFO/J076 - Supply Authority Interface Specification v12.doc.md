...
29/01/2007
1.0
Review comments incorporated. Please refer the doc-share for review comments
Supriyo Chakraborty
03/03/07
1.1
Pseudo code for mapping is incorporated in document.
Sankar G
23/04/2007
1.2
CR Raised for the following defect 
1869 - The filename is not correct
Mapping document & Context diagram changed
...
Mapping spreadsheet
http://docshare/UK IT/TOM Integration/Shared Documents/1 - Design/Interface Design Documents/GFO Interfaces (J-Prefix)/J076 Supply Authority IDS to GFO/J076 - Supply Authority to GFO Mappings V30.xls
Table of Contents
 TOC \o "1-3" \t "Appendix,1" 1	Introduction	 PAGEREF _Toc157177456 \h 3
1.1	Purpose of Document	 PAGEREF _Toc157177457 \h 3
1.2	Background	 PAGEREF _Toc157177458 \h 3
1.3	Scope	 PAGEREF _Toc157177459 \h 3
2	Description and Requirements for the End-to-End Interface	 PAGEREF _Toc157177460 \h 3
2.1	Description of the End-to-End Interface	 PAGEREF _Toc157177461 \h 3
2.2	Architecture	 PAGEREF _Toc157177462 \h 3
2.3	Requirements for the End-to-End Interface	 PAGEREF _Toc157177463 \h 3
3	Processing required in an Extract-Stage of the interface	 PAGEREF _Toc157177464 \h 3
3.1	Scope	 PAGEREF _Toc157177465 \h 3
3.2	Source Message Schema	 PAGEREF _Toc157177466 \h 3
3.3	Message Transport Details	 PAGEREF _Toc157177467 \h 3
3.4	Naming and Configuration	 PAGEREF _Toc157177468 \h 3
3.5	Environment and Security Context	 PAGEREF _Toc157177469 \h 3
3.6	Non-Functional Requirements	 PAGEREF _Toc157177470 \h 3
4	Processing required in the Messaging Stage of the interface	 PAGEREF _Toc157177471 \h 3
4.1	Scope	 PAGEREF _Toc157177472 \h 3
4.2	Data Validation	 PAGEREF _Toc157177473 \h 3
4.3	Filtering	 PAGEREF _Toc157177474 \h 3
4.4	Mapping	 PAGEREF _Toc157177475 \h 3
4.5	Target Message Schema	 PAGEREF _Toc157177476 \h 3
4.6	Sample Target Message	 PAGEREF _Toc157177477 \h 3
4.7	Message Transport Details	 PAGEREF _Toc157177478 \h 3
4.8	Naming and Configuration	 PAGEREF _Toc157177479 \h 3
4.9	Environment and Security Context	 PAGEREF _Toc157177480 \h 3
4.10	Non-Functional Requirements	 PAGEREF _Toc157177481 \h 3
5	Processing required in the <third stage of the interface>	 PAGEREF _Toc157177482 \h 3
5.1	Scope	 PAGEREF _Toc157177483 \h 3
5.2	Data Validation	 PAGEREF _Toc157177484 \h 3
5.3	Filtering	 PAGEREF _Toc157177485 \h 3
5.4	Mapping	 PAGEREF _Toc157177486 \h 3
5.5	Target Message Schema	 PAGEREF _Toc157177487 \h 3
5.6	Message Transport Details	 PAGEREF _Toc157177488 \h 3
5.7	Naming and Configuration	 PAGEREF _Toc157177489 \h 3
5.8	Environment and Security Context	 PAGEREF _Toc157177490 \h 3
5.9	Non-Functional Requirements	 PAGEREF _Toc157177491 \h 3
6	Testing Deliverables	 PAGEREF _Toc157177492 \h 3
7	Deployment	 PAGEREF _Toc157177493 \h 3
8	Assumptions and Outstanding Issues	 PAGEREF _Toc157177494 \h 3
8.1	Assumptions	 PAGEREF _Toc157177495 \h 3
8.2	Outstanding Issues PAGEREF _Toc157177496 \h 3
Appendix A Volumes	 PAGEREF _Toc157177497 \h 3
Appendix B Glossary	 PAGEREF _Toc157177498 \h 3
Appendix C Document Control	 PAGEREF _Toc157177499 \h 3
...
The Oracle Retail Merchandising system is considered the master, and therefore the source for the item supplier data. This data is published into the integration layer (via RIB messages in Oracle Retail v12, via files in Oracle Retail v10), and is written to the IDS. This interface is concerned with moving supplier data from the IDS to GFO only. The flow of item supplier data from the source system, ORMS, to the IDS, is covered by different interface specifications (C001TR, C001US, C010TR and C010US). At the point of writing this interface specification, these documents were not in doc-share. It will be put in Doc-share in the location http://docshare/UK IT/TOM Integration/Shared Documents/1 - Design/Interface Design Documents/Commercial Interfaces (C-Prefix)
...
Scope
A scheduled batch job/s runs, at a pre-configured time, to extract the Supplier Authority data from the Integration Data Store (IDS). This batch job in turn kicks off a process that executes SQL server Integration Service package. The package will execute a stored procedure associated with this interface. The stored procedure will unload the complete data through various common form services available on temporary tables on the transient database. 

The next step on the stored procedure is to collate the data collected on the various temporary tables in the desired format that this interface requires. The output of common form services will be in xml and the interface stored procedures will return the result sets.
...
Objective:
The Supplier Authority data to be picked up from the IDS tables and populate in a COBOL format file. All Supplier Authority data is to be sent to GFO.

Method:
There are six entities involved in picking up the data. Those are: SKUSupplierCountryOfOrigin, TradePackSupplierCountryOfOrigin, TradePack, PackItemBreakout, SKUItemInWarehouse and Warehouse.

The Item Hierarchy is constituted of four entities namely: SKUSupplierCountryOfOrigin, TradePackSupplierCountryOfOrigin, TradePack and PackItemBreakout. For this in the logical data model TOM.Common.Schema.Items.xml common form is used. However PackItemBreakout is not available in the above common form. The table will be available in IDS Data Model.

The Warehouse information (Stock Centre) is coming from SKUItemInWarehouse and Warehouse entities. For this information TOM.Common.Schema.Warehouse.xml common form is used. SKUItemInWarehouse entity is not available in the TOM.Common.Schema.Warehouse.xml common form. But the information from SKUItemWarehouse is implicitly available in the TOM.Common.Schema.Warehouse.xml common form. The information is utilised in this interface.

Mapping document will be provided subsequently.

Please refer the spreadsheet. Location :( as mentioned in the Document Source -> Mapping Spreadsheet)
...
Tesco IT Group Technology and Architecture	 TITLE  \* MERGEFORMAT J076 Supply Authority Interface Specification
	...
	Page:  PAGE  \* MERGEFORMAT 3 of  NUMPAGES 22	Date:  SAVEDATE \@ "d MMM yyyy" 6 Mar 2007
...
Tesco IT Group Technology and Architecture	 TITLE  \* MERGEFORMAT J076 Supply Authority Interface Specification
	...
	Page:  PAGE  \* MERGEFORMAT 22 of  NUMPAGES 21	Date:  SAVEDATE \@ "d MMM yyyy" 6 Mar 2007
