...
J0087 - Information Context Diagram –StoreReferenceData.vsd

Mapping spreadsheet
J0087 – Store Reference Data to GFO Mappings v2.0.xls
Table of Contents
...
This common form returns the all Stores Information from IDS data store including Store Address Details.
...
Version  REF DOC_VER Error! Reference source not found., Issue  REF DOC_STATUS Draft	Page:  PAGE  \* MERGEFORMAT 22 of  NUMPAGES 22	Date:  SAVEDATE \@ "d MMM yyyy" 2 Mar 2007
