...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| NaN | IDS Store Locations to GFO | NaN | NaN | NaN | NaN | Version 3.0 | NaN | NaN | Notes/Issues Key | NaN | NaN | NaN | NaN | NaN | NaN | Key to Mandatory Column | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN |
...
| NaN | Target File Name: IDS.Store.CCYYMMDDHHmmss.DAT | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | Not mapped/Set Field Value | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN |
...
| NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | HEADER: Record type = 0\nDETAIL: Record type = 1\nTRAILER - Record type = 9\nNo Line Delimiter between every record. Entire file will be in single line. | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN |
| NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN | NaN |
...
| NaN | NaN | NaN | Address | PhoneNumber | varchar | NaN | NaN | 20 | NaN | SELECT Address.PhoneNumber\nFROM Address \nWhere Address.AddressID = Store.AddressID | NaN | NaN | NaN | NaN | Detail | NaN | NaN | CHBCB-RO-PHONE-1-NO | Char | 141 | 157 | 17 | N | NaN | X(17) | NaN | NaN | NaN | Common Form: TOM.Common.Schema.Stores\nEntity: Stores\nReference: sto:store\nReference Entity: Addess\nReference Element: PhoneNumber |
...
| NaN | NaN | NaN | Address | State | Varchar | NaN | NaN | 3 | NaN | SELECT Address.State \nFROM Address\nWHERE Address.AddressID = :Store.AddressID | NaN | NaN | NaN | NaN | Detail | NaN | NaN | CHBCB-REGION-GROUP-NO | Numeric | 266 | 268 | 3 | Y | NaN | 999 | NaN | NaN | NaN | Common Form: TOM.Common.Schema.Stores\nEntity: Stores\nReference: sto:store\nReference Entity: Addess\nElement: State |
