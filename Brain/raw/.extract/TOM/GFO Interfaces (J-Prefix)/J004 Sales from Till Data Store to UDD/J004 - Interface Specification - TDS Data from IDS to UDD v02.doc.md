...
Create a comma delimited flat file (TDS_Sales_History_nnnnnnn.csv) containing the aggregated data, and place the file in the staging directory ‘IL_outbox’ within the IL. The ‘nnnnnnn’ of the file name is the 7 character numeric right justified 0 padded ‘SequenceNumber’. 
...
An RTI Shipping Agent Hosted Instruction “TOM.J004.RTStoUDD.SalesDataFileDelivery” will:
Subscribe to the ‘IL_outbox’ directory, identifying the Sales Data file based on name pattern: ‘J004_TDS_Sales_History*.csv’,
...
Tarrget: J004_TDS_Sales_History_nnnnnnn.csv comma delimited flat file.
...
SSIS
Package Name: TOM.J004.TDStoUDD.SalesHistory.dtsx
Stored Procedure
Name
...
SQL Agent Job
Name
TOM.J002.TDStoUDD.SalesHistory
Location
TBD
...
J004_TDS_Sales_History_nnnnnnn.csv
...
Version  REF DOC_VER 0.1, Issue  REF DOC_STATUS Draft	Page:  PAGE  \* MERGEFORMAT 18 of  NUMPAGES 27	Date:  SAVEDATE \@ "d MMM yyyy" 14 Mar 2007
