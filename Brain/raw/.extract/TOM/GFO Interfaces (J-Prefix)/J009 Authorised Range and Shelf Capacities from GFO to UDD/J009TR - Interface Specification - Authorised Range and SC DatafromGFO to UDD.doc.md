...
Authorised Range and Shelf Capacity Data
From GFO to UDD
...
Introduction
Purpose of Document
The purpose of this document is to describe the requirements for the interface of Authorised Range and Shelf Capacity Data from the Group Forecast and Order system (GFO) to the User Data Database (UDD) within the Integration Layer (IL). This User Data is needed by the Allocations process.
...
After End of Store Day, GFO will produce one file containing the Authorised Range and Shelf Capacity data, which the Integration Layer (IL) will immediately pass to the UDD upload directory, also within the IL, ready for uploading into the UDD. The file will be passed as is, without changing it’s name or data structure.
...
Architecture
GFO will publish the Authorised Range and Shelf Capacity data file (‘GFO_Range_SC.csv’) within a shared windows (CIFS) directory (‘GFO_outbox’) on the GFO host.

An RTI Shipping Agent Hosted Instruction “J009TR.GFO to UDD.Authorised Range and SC File Delivery” will:

Identify the Supplier Authority file based on name: ‘GFO_Range_SC.csv’
...
Scope
The integration layer purely passes the Authorised Range and Shelf Capacity data file from the GFO shared directory to the UDD upload directory without changing it’s name or structure.
...
J009TR.GFO to UDD.Authorised Range and SC File Delivery




RTI
Instruction Name: J009TR.GFO to UDD.Authorised Range and SC File Delivery
Instruction Details
Description
File delivery of Authorised Range and SC Data file from GFO to UDD
Enabled
True
Type
Hosted
...
Version  REF DOC_VER 0.1, Issue  REF DOC_STATUS Draft	Page:  PAGE  \* MERGEFORMAT 15 of  NUMPAGES 19	Date:  SAVEDATE \@ "d MMM yyyy" 16 Feb 2007
...
Version  REF DOC_VER 0.1, Issue  REF DOC_STATUS Draft	Page:  PAGE  \* MERGEFORMAT 19 of  NUMPAGES 19	Date:  SAVEDATE \@ "d MMM yyyy" 16 Feb 2007
