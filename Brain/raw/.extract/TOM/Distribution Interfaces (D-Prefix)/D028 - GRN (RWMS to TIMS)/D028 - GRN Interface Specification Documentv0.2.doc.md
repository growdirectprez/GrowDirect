...
Message Format
The source message is in the form of a RIB XML message from ORWMS and is getting converted into the target XML file format in a package. The following sample message format is the source message format. 
...
Output Records will terminate CR (Carriage Return) as they are for Unix.
Message Format
Formatted test data will be provided.
...
Version  REF DOC_VER 0.1, Issue  REF DOC_STATUS Draft	Page:  PAGE  \* MERGEFORMAT ii of  NUMPAGES 22	Date:  SAVEDATE \@ "d MMM yyyy" 19 Feb 2007
