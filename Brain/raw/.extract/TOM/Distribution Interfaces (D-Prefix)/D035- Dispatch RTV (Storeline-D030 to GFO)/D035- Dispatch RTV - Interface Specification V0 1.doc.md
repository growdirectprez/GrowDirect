...
Processing should prevent sending of duplicate messages, unless this occurs during recovery from failure.
Currently it will keep all error details in a txt file. Later this may change as per the business requirement.
...
Erwin Oguz
6
Stock Movement Reason code from STORELINE to GFO need to be defined
Erwin Oguz
...
Version  REF DOC_VER Error! Reference source not found., Issue  REF DOC_STATUS Draft	Page:  PAGE  \* MERGEFORMAT 22 of  NUMPAGES 25	Date:  SAVEDATE \@ "d MMM yyyy" 12 Feb 2007
