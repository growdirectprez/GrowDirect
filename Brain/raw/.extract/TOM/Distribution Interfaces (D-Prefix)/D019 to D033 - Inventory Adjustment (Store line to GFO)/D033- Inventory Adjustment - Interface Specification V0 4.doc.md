...
Table of Contents
 TOC \o "1-3" \t "Appendix,1" 1	Introduction	 PAGEREF _Toc159143555 \h 7
1.1	Purpose of Document	 PAGEREF _Toc159143556 \h 7
1.2	Background	 PAGEREF _Toc159143557 \h 7
1.3	Scope	 PAGEREF _Toc159143558 \h 7
2	Description and Requirements for the End-to-End Interface	 PAGEREF _Toc159143559 \h 8
2.1	Description of the End-to-End Interface	 PAGEREF _Toc159143560 \h 8
2.2	Architecture	 PAGEREF _Toc159143561 \h 8
2.3	Requirements for the End-to-End Interface	 PAGEREF _Toc159143562 \h 9
3	Processing required in an Extract-Stage of the interface	 PAGEREF _Toc159143563 \h 10
3.1	Scope	 PAGEREF _Toc159143564 \h 10
3.2	Source Message Schema	 PAGEREF _Toc159143565 \h 10
3.3	Message Format	 PAGEREF _Toc159143566 \h 11
3.4	Message Transport Details	 PAGEREF _Toc159143567 \h 12
3.5	Naming and Configuration	 PAGEREF _Toc159143568 \h 12
3.6	Environment and Security Context	 PAGEREF _Toc159143569 \h 12
3.7	Non-Functional Requirements	 PAGEREF _Toc159143570 \h 13
4	Processing required in the Messaging Stage of the interface	 PAGEREF _Toc159143571 \h 14
4.1	Scope	 PAGEREF _Toc159143572 \h 14
4.2	Data Validation	 PAGEREF _Toc159143573 \h 14
4.3	Filtering	 PAGEREF _Toc159143574 \h 14
4.4	Stored Procedures	 PAGEREF _Toc159143575 \h 14
4.5	JH0S00 – Stream information retrieved	 PAGEREF _Toc159143576 \h 14
4.6	JIP11 – process wastage	 PAGEREF _Toc159143577 \h 14
4.7	JIP12 – process stock counts	 PAGEREF _Toc159143578 \h 14
4.8	JIP13 – process stock adjustment	 PAGEREF _Toc159143579 \h 15
4.9	Mapping	 PAGEREF _Toc159143580 \h 15
4.10	Mapping of JH0S00 – Package to return STREAM info	 PAGEREF _Toc159143581 \h 15
4.11	Mapping of JIP11 – process wastage	 PAGEREF _Toc159143582 \h 16
4.12	Mapping of JIP12 – process stock adjustment	 PAGEREF _Toc159143583 \h 17
4.13	Mapping of JIP13 – process stock adjustment	 PAGEREF _Toc159143584 \h 17
4.14	Message Format	 PAGEREF _Toc159143585 \h 18
4.7 Message Transport Details	 PAGEREF _Toc159143586 \h 18
4.15	Naming and Configuration	 PAGEREF _Toc159143587 \h 20
4.16	Environment and Security Context	 PAGEREF _Toc159143588 \h 20
4.17	Non-Functional Requirements	 PAGEREF _Toc159143589 \h 20
5	Processing required in the <third stage of the interface>	 PAGEREF _Toc159143590 \h 21
5.1	Scope	 PAGEREF _Toc159143591 \h 21
5.2	Data Validation	 PAGEREF _Toc159143592 \h 21
5.3	Filtering	 PAGEREF _Toc159143593 \h 21
5.4	Mapping	 PAGEREF _Toc159143594 \h 21
5.5	Target Message Schema	 PAGEREF _Toc159143595 \h 21
5.6	Message Transport Details	 PAGEREF _Toc159143596 \h 21
5.7	Naming and Configuration	 PAGEREF _Toc159143597 \h 21
5.8	Environment and Security Context	 PAGEREF _Toc159143598 \h 21
5.9	Non-Functional Requirements	 PAGEREF _Toc159143599 \h 21
6	Testing Deliverables	 PAGEREF _Toc159143600 \h 22
7	Deployment	 PAGEREF _Toc159143601 \h 23
8	Assumptions and Outstanding Issues	 PAGEREF _Toc159143602 \h 24
8.1	Assumptions	 PAGEREF _Toc159143603 \h 24
8.2	Outstanding Issues	 PAGEREF _Toc159143604 \h 24
Appendix A Volumes	 PAGEREF _Toc159143605 \h 25
•	Glossary	 PAGEREF _Toc159143606 \h 26
Appendix B Document Control	 PAGEREF _Toc159143607 \h 27

Introduction
Purpose of Document
The purpose of this document is to describe the interfacing requirements with respect to STORELINE inventory adjustment data e.g. Wastage (out-of-code and damaged), Stock counts & Stock take adjustment into GFO.
...
The interface is to upload the Inventory Adjustment data (Wastage, Stock counts & Stock take adjustment) from STORELINE into GFO. The Upload is a full upload in nature.

The interface will be governed by BizTalk Orchestration, which expects the Inventory Adjustment data (| delimited flat file) from STORELINE interface. The STORELINE interface will put this file (*.dat) in the shared location through RTI SOAP adapter. The BizTalk server then transfers this flat file data by invoking GFO stored procedures through DB2 adopter. BizTalk will first invokes JH0S00  –  stored procedure to get the stream information which is passed to subsequent stored procedure JIP11 for stock wastage(Region code-327),JIP12 for Stock Count(Region Code-315) & JIP13 for Stock Adjustment(Region Code-323). This then get updated/inserted in GFO underlying table. The output attributes returned by stored procedure will determine the success/failure of this updating.
...
Scope
STORELINE creates a pipe | delimited flat file on real time basis whenever it receives an inventory adjustment data. BizTalk in turn picks up the file from the shared location and invokes series of subroutines through DB2 Adopter to update/insert the underline table of GFO. 
...
Scope
The BizTalk server transfers the source message schema file to GFO by invoking a series of stored procedures within DB2.This will first invokes JH0S00 – stored procedure to get the stream information which is passed along with other input attributes to get updated/inserted in GFO underlying table. 
Data Validation
...
Wastage (out-of-code and damaged) – Region Code 327
Stock counts – Region Code 315
Stock Adjustment – Region Code 323
...
This stored procedure get invoked when the ROWSET contains the Region Code 315.The foot-print of this stored procedure with it’s ROWSET mapping details are given below –
...
This stored procedure get invoked when the ROWSET contains the Region Code 323.The foot-print of this stored procedure with it’s ROWSET mapping details are given below –
...
Version  REF DOC_VER Error! Reference source not found., Issue  REF DOC_STATUS Draft	Page:  PAGE  \* MERGEFORMAT v of  NUMPAGES 27	Date:  SAVEDATE \@ "d MMM yyyy" 12 Feb 2007
