...
Updated working draft
Completed working draft
Technical committee feedback included
Updated to reflect revised scope of Version 1.0
...
A retail location in which Inventory for sale is displayed to the
customer  in  a  showroom  and  then  retrieved  for  the  customer
from a stock room in or near the retail location.

The  Count,  Location,  Acquisition,  Depletion,  Disposition  &
Valuation of items; which are things that a retailer keeps track
of:

o

Inputs to a manufacturing process, e.g., bulk flour that
is used in a bakery to make bread.

o  Goods in the process of being produced prior to being
ready for sale, e.g., dough that is created in a bakery as
part of the manufacturing process for a loaf of bread.

o  The  finished  output  from  the  manufacturing  process,

e.g., a finished loaf of bread.

o  Discrete items that are ordered & sold.
o  Discrete  items  that  are  used  in  the  operation  of

fulfilling retail operations.

Inventory Count

Quantity and defined unit of measure of an inventory item.

Inventory Location

Physical location of an inventory item.

Inventory Acquisition

The methods of adding an inventory item to inventory.

Inventory Depletion

The  methods  of  removing  an  inventory  item  from  inventory;
some examples are:
...
The state of an inventory item; some examples are:
...
The monetary worth of an inventory item or a grouping within
the Merchandise Hierarchy.  Some examples include:

o  Missing

o  Actual Cost
o  Replacement Cost
o  Nominal Retail Value

Merchandise Hierarchy  A  hierarchy  of  reporting  groups  that  aggregates  individual

inventory items for the purposes of reporting & management.

Replenishment

The process of arranging to receive more inventory items.
...
Receiving merchandise into the store inventory.  This includes
the receipt of transfers from warehouses, transfers from other
stores and direct store deliveries from vendors.

The  process  of  responding  to  customer  inquiries,  orders  or
sales promotion offers
The  process  of  comparing  the  records  of  receiving  with  the
originating order.

The  process  of  comparing  invoices  with  receiving  records  &
originating orders, and authorizing payment.

The exchange of goods and services for tender or other items
of value with a customer.
