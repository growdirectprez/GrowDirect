...
### 1A. Module M — Merchandising (26 L3s — full module GAP)
...
| M — Merchandising | 26 | All TBD | Medium — M.4.x L4s can be derived from Q rule catalog patterns |
...
| O — Orders | 47 | All TBD | High — O.6/O.7 (receiving, RTV) directly mappable; O.1–O.5 need forecasting algorithm docs |
...
| E — Execution | 14 | All TBD | Low (v3 capstone; blocked on Q Fox stabilization) |
| **TOTAL** | **357** | **All TBD** | |
...
| Gap: E — Execution cmd/work not built (v3, 14 L3s) | W | 14 | M5 — v3 Ring | Blocked on Q Fox stabilization |
