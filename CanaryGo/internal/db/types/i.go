// Code generated from deploy/schema/05_i_inventory.sql for Loop 2 (GRO-761).
...
type InventoryDocumentLine struct {
	...
	ItemID           uuid.UUID       `db:"item_id"`
	ExpectedQuantity *string         `db:"expected_quantity"` // numeric — decimal.Decimal dep needed; using string for Loop 2
	ActualQuantity   *string         `db:"actual_quantity"`   // numeric — decimal.Decimal dep needed; using string for Loop 2
...
type InventoryPosition struct {
	...
	OnHandQuantity     string          `db:"on_hand_quantity"`     // numeric — decimal.Decimal dep needed; using string for Loop 2
	ReservedQuantity   string          `db:"reserved_quantity"`    // numeric — decimal.Decimal dep needed; using string for Loop 2
	OnOrderQuantity    string          `db:"on_order_quantity"`    // numeric — decimal.Decimal dep needed; using string for Loop 2
	InTransitQuantity  string          `db:"in_transit_quantity"`  // numeric — decimal.Decimal dep needed; using string for Loop 2
