...
**Session prompt:** `Condor_B067_CapabilityMap.md` (write separately for Condor's tab)
...
**Session prompt:** `Jeremy_B067_APIModule.md` (write separately for Jeremy's tab)
...
**Session prompt:** `Qwen_B067_DashboardShell.md` (write separately for Qwen's tab)
