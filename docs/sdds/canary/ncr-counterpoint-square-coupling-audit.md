...
| `app/customers.py:36,67` | `square_customer_id` + index | Upsert key, customer-tier resolution | Same pattern: `external_identities`-mediated. Counterpoint customer pull (Module R) is straightforward to layer on. | MED | M |
